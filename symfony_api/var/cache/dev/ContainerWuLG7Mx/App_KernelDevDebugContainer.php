...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(private array $buildParameters = [], protected string $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            'App\\Controller\\DataController' => 'getDataControllerService',
    ...
    protected static function getHttpKernelService($container)
    {
        ...
        $a->allowControllers(['App\\Kernel', 'App\\Controller\\DataController']);
    ...
    private function getDynamicParameter(string $name)
    {
        ...
        $value = match ($name) {
            ...
            'db.host' => $container->getEnv('DB_HOST'),
            'db.user' => $container->getEnv('DB_USER'),
            'db.password' => $container->getEnv('DB_PASSWORD'),
            'db.database' => $container->getEnv('DB_NAME'),
